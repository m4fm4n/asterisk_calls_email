...
find /var/www/html/records/files/ -type f -size +5 -mtime 0 -daystart -regex '.*\(\/0[0-7]\|\/1[6-9][0-5][0-9][0-9][0-9]\|\/2[0-3][0-5][0-9][0-9][0-9]\).*3758800\.mp3' | xargs cp -t /home/adminotel/magiccalls/3758800/
...
find /var/www/html/records/files/ -type f -size +5 -mtime 0 -daystart -regex '.*\(\/0[0-7]\|\/1[6-9][0-5][0-9][0-9][0-9]\|\/2[0-3][0-5][0-9][0-9][0-9]\).*3758801\.mp3' | xargs cp -t /home/adminotel/magiccalls/3758801/
